...
namespace ncore
{
    namespace nwakeup
    {
        ...
        static const char* s_wakeup_reasons[] = {
        ...
        const char* to_string(reason_t reason) { return s_wakeup_reasons[reason & 0x0F]; }

        void deepsleep()  // start deep sleep (external wakeup only)
        {
#ifdef TARGET_ESP32
